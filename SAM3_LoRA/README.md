...
Example: Concrete Crack Detection
...
Reduce Batch Size in configs/full_lora_config.yaml:
...
Increase batch_size from 1 to 2 (reduces gradient variance)
Check data_dir in config points to correct location
Reduce LoRA rank if getting OOM errors (64 → 32)
...
Adjust NMS Thresholds in validate_sam3_lora.py:
...
Use Lighter LoRA for small datasets:
...
Use Smaller Validation Subset during training:
